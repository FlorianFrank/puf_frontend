...
import WaferEvaluationTable from "./WaferEvaluationTable";
    ...
    let requestVisualization = async () => {
        await fetch_get(FETCH_VISUALIZATION_RESULT + identifier, (value) => {
            ...
            if (retData) {
                ...
                console.log("EVALSTATUS ", retData['evaluationStatus'])
        ...
        <div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl">
            ...
            <StyledCard sx={{width: '100%'}}>
                ...
                <CardContent>
                    ...
                    <FigurePlotter visualizerJson={visualization} width={1600} height={1200}
                                   fig_name={fig_name}/>
                    <div id={fig_name}/>
                </CardContent>
            </StyledCard>
