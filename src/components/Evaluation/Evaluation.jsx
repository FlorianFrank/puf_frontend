...
// this function is resposible for diplaying the header of the table
    ...
    >
      {numSelected > 0 ? (
        <Typography
          ...
          component="div"
        >
          {numSelected} selected PUF response{numSelected > 1 ? 's' : ''}
        </Typography>
      ) : (
        <Typography
          sx={{ flex: '1 1 100%' }}
...
export default function Evaluation() {
  ...
  const handleClick = (event, row) => {
    // -1 means the element not present.
    console.log('row', row);
                  ...
                  .map((row, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="left">{row.testTitle}</TableCell>
